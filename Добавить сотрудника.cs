...
namespace Centr
{
    public partial class Добавить_сотрудника : Form
    {
        ...
        private void Добавить_button2_Click(object sender, EventArgs e)
        {
            ...
            string sql = "INSERT INTO sotrudniki (fio, id_vozr, id_opita, telephon, id_g, id_ul, id_d, id_k, id_dolj, id_kursi, login, parol ) VALUES ('" + ФИО_textBox1.Text + "'," 
                + kod_1 + "," + kod_2 + ",'" + Телефон_textBox5.Text + "'," + kod_5 + "," + kod_6 + "," + kod_7 + "," + kod_8 + "," + kod_3 + "," + kod_4 + ",'" + Логин_textBox8.Text + "','" + Пароль_textBox7.Text + "')";
